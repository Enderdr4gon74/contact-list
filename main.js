...
function toggleAddContactForm() {
  let formElement = document.getElementById("new-contact-form").classList
  if (formElement.contains("hidden")) {
    formElement.remove("hidden")
  } else if (!formElement.contains("hidden")) {
    formElement.add("hidden")
  }
}
